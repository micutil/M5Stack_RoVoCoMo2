...
#### 更新方法
ver 1.9に既に更新済みの場合（ロビ２用Ninshiki.csvの更新：2019/5/4 23:30）

- ROBI2フォルダをmicroSDにコピーする
- ロビ２を使っている場合は、ROBI2フォルダの中のNinshiki.csvをmicroSDのルートにコピーします。

ver 1.8以前からの更新

- RoVoCoMo2.bin, ROBI1フォルダ, および,ROBI2フォルダをmicroSDにコピーする
